...
"use strict";var auth=require("./lib/auth"),helpers=require("./lib/helpers"),SwaggerClient=require("./lib/client"),deprecationWrapper=function(e,t){return helpers.log('This is deprecated, use "new SwaggerClient" instead.'),new SwaggerClient(e,t)};Array.prototype.indexOf||(Array.prototype.indexOf=function(e,t){for(var r=t||0,i=this.length;i>r;r++)if(this[r]===e)return r;return-1}),String.prototype.endsWith||(String.prototype.endsWith=function(e){return-1!==this.indexOf(e,this.length-e.length)}),module.exports=SwaggerClient,SwaggerClient.ApiKeyAuthorization=auth.ApiKeyAuthorization,SwaggerClient.PasswordAuthorization=auth.PasswordAuthorization,SwaggerClient.CookieAuthorization=auth.CookieAuthorization,SwaggerClient.SwaggerApi=deprecationWrapper,SwaggerClient.SwaggerClient=deprecationWrapper;
},{"./lib/auth":2,"./lib/client":3,"./lib/helpers":4}],2:[function(require,module,exports){
"use strict";var btoa=require("btoa"),CookieJar=require("cookiejar"),SwaggerAuthorizations=module.exports.SwaggerAuthorizations=function(){this.authz={}};SwaggerAuthorizations.prototype.add=function(t,o){return this.authz[t]=o,o},SwaggerAuthorizations.prototype.remove=function(t){return delete this.authz[t]},SwaggerAuthorizations.prototype.apply=function(t,o){var i,e,r,a,u=null;if("undefined"==typeof o||0===Object.keys(o).length)for(i in this.authz)r=this.authz[i],a=r.apply(t,o),a===!0&&(u=!0);else if(Array.isArray(o))for(var n=0;n<o.length;n++){var s=o[n];for(e in s)for(i in this.authz)i===e&&(r=this.authz[i],a=r.apply(t,o),a===!0&&(u=!0))}else for(e in o)for(i in this.authz)i===e&&(r=this.authz[i],a=r.apply(t,o),a===!0&&(u=!0));return u};var ApiKeyAuthorization=module.exports.ApiKeyAuthorization=function(t,o,i){this.name=t,this.value=o,this.type=i};ApiKeyAuthorization.prototype.apply=function(t){return"query"===this.type?(t.url.indexOf("?")>0?t.url=t.url+"&"+this.name+"="+this.value:t.url=t.url+"?"+this.name+"="+this.value,!0):"header"===this.type?(t.headers[this.name]=this.value,!0):void 0};var CookieAuthorization=module.exports.CookieAuthorization=function(t){this.cookie=t};CookieAuthorization.prototype.apply=function(t){return t.cookieJar=t.cookieJar||new CookieJar,t.cookieJar.setCookie(this.cookie),!0};var PasswordAuthorization=module.exports.PasswordAuthorization=function(t,o,i){this.name=t,this.username=o,this.password=i};PasswordAuthorization.prototype.apply=function(t){return t.headers.Authorization="Basic "+btoa(this.username+":"+this.password),!0};


},{"btoa":16,"cookiejar":17}],3:[function(require,module,exports){
"use strict";var _={bind:require("lodash-compat/function/bind"),cloneDeep:require("lodash-compat/lang/cloneDeep"),find:require("lodash-compat/collection/find"),forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isFunction:require("lodash-compat/lang/isFunction"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isUndefined:require("lodash-compat/lang/isUndefined")},auth=require("./auth"),helpers=require("./helpers"),Model=require("./types/model"),Operation=require("./types/operation"),OperationGroup=require("./types/operationGroup"),Resolver=require("./resolver"),SwaggerHttp=require("./http"),SwaggerSpecConverter=require("./spec-converter"),reservedClientTags=["authorizationScheme","authorizations","basePath","build","buildFrom1_1Spec","buildFrom1_2Spec","buildFromSpec","clientAuthorizations","convertInfo","debug","defaultErrorCallback","defaultSuccessCallback","fail","failure","finish","help","idFromOp","info","initialize","isBuilt","isValid","models","modelsArray","options","parseUri","progress","resourceCount","sampleModels","selfReflect","setConsolidatedModels","spec","supportedSubmitMethods","swaggerRequestHeaders","tagFromLabel","url","useJQuery"],reservedApiTags=["apis","asCurl","description","externalDocs","help","label","name","operation","operations","operationsArray","path","tag"],supportedOperationMethods=["delete","get","head","options","patch","post","put"],SwaggerClient=module.exports=function(e,t){return this.authorizationScheme=null,this.authorizations=null,this.basePath=null,this.debug=!1,this.info=null,this.isBuilt=!1,this.isValid=!1,this.modelsArray=[],this.resourceCount=0,this.url=null,this.useJQuery=!1,"undefined"!=typeof e?this.initialize(e,t):this};SwaggerClient.prototype.initialize=function(e,t){this.models={},this.sampleModels={},t=t||{},"string"==typeof e?this.url=e:"object"==typeof e&&(t=e,this.url=t.url),this.swaggerRequestHeaders=t.swaggerRequestHeaders||"application/json;charset=utf-8,*/*",this.defaultSuccessCallback=t.defaultSuccessCallback||null,this.defaultErrorCallback=t.defaultErrorCallback||null,"function"==typeof t.success&&(this.success=t.success),t.useJQuery&&(this.useJQuery=t.useJQuery),t.authorizations?this.clientAuthorizations=t.authorizations:this.clientAuthorizations=new auth.SwaggerAuthorizations,this.supportedSubmitMethods=t.supportedSubmitMethods||[],this.failure=t.failure||function(){},this.progress=t.progress||function(){},this.spec=_.cloneDeep(t.spec),this.options=t,"function"==typeof t.success&&(this.ready=!0,this.build())},SwaggerClient.prototype.build=function(e){if(this.isBuilt)return this;var t=this;this.progress("fetching resource list: "+this.url);var i={useJQuery:this.useJQuery,url:this.url,method:"get",headers:{accept:this.swaggerRequestHeaders},on:{error:function(e){return t.fail("http"!==t.url.substring(0,4)?"Please specify the protocol for "+t.url:0===e.status?"Can't read from server.  It may not have the appropriate access-control-origin settings.":404===e.status?"Can't read swagger JSON from "+t.url:e.status+" : "+e.statusText+" "+t.url)},response:function(e){var i=e.obj||JSON.parse(e.data);if(t.swaggerVersion=i.swaggerVersion,i.swagger&&2===parseInt(i.swagger))t.swaggerVersion=i.swagger,(new Resolver).resolve(i,t.buildFromSpec,t),t.isValid=!0;else{var s=new SwaggerSpecConverter;s.setDocumentationLocation(t.url),s.convert(i,function(e){(new Resolver).resolve(e,t.buildFromSpec,t),t.isValid=!0})}}}};if(this.spec)setTimeout(function(){(new Resolver).resolve(t.spec,t.buildFromSpec,t)},10);else{if(this.clientAuthorizations.apply(i),e)return i;(new SwaggerHttp).execute(i)}return this},SwaggerClient.prototype.buildFromSpec=function(e){if(this.isBuilt)return this;this.apis={},this.apisArray=[],this.basePath=e.basePath||"",this.consumes=e.consumes,this.host=e.host||"",this.info=e.info||{},this.produces=e.produces,this.schemes=e.schemes||[],this.securityDefinitions=e.securityDefinitions,this.title=e.title||"",e.externalDocs&&(this.externalDocs=e.externalDocs),this.authSchemes=e.securityDefinitions;var t,i={};if(Array.isArray(e.tags))for(i={},t=0;t<e.tags.length;t++){var s=e.tags[t];i[s.name]=s}var r;"string"==typeof this.url&&(r=this.parseUri(this.url)),"undefined"==typeof this.schemes||0===this.schemes.length?this.scheme=r.scheme||"http":this.scheme=this.schemes[0],("undefined"==typeof this.host||""===this.host)&&(this.host=r.host,r.port&&(this.host=this.host+":"+r.port)),this.definitions=e.definitions;var o;for(o in this.definitions){var a=new Model(o,this.definitions[o],this.models);a&&(this.models[o]=a)}var n=this;return n.apis.help=_.bind(n.help,n),_.forEach(e.paths,function(e,t){_.isPlainObject(e)&&_.forEach(supportedOperationMethods,function(s){var r=e[s];if(!_.isUndefined(r)){if(!_.isPlainObject(r))return void helpers.log("The '"+s+"' operation for '"+t+"' path is not an Operation Object");var o=r.tags;(_.isUndefined(o)||!_.isArray(o)||0===o.length)&&(o=r.tags=["default"]);var a=n.idFromOp(t,s,r),l=new Operation(n,r.scheme,a,s,t,r,n.definitions,n.models,n.clientAuthorizations);_.forEach(o,function(e){var t=_.indexOf(reservedClientTags,e)>-1?"_"+e:e,s=_.indexOf(reservedApiTags,e)>-1?"_"+e:e,r=n[t];if(t!==e&&helpers.log("The '"+e+"' tag conflicts with a SwaggerClient function/property name.  Use 'client."+t+"' or 'client.apis."+e+"' instead of 'client."+e+"'."),s!==e&&helpers.log("The '"+e+"' tag conflicts with a SwaggerClient operation function/property name.  Use 'client.apis."+s+"' instead of 'client.apis."+e+"'."),_.indexOf(reservedApiTags,a)>-1&&(helpers.log("The '"+a+"' operationId conflicts with a SwaggerClient operation function/property name.  Use 'client.apis."+s+"._"+a+"' instead of 'client.apis."+s+"."+a+"'."),a="_"+a,l.nickname=a),_.isUndefined(r)){r=n[t]=n.apis[s]={},r.operations={},r.label=s,r.apis={};var o=i[e];_.isUndefined(o)||(r.description=o.description,r.externalDocs=o.externalDocs),n[t].help=_.bind(n.help,r),n.apisArray.push(new OperationGroup(e,r.description,r.externalDocs,l))}_.isFunction(r.help)||(r.help=_.bind(n.help,r)),n.apis[s][a]=r[a]=_.bind(l.execute,l),n.apis[s][a].help=r[a].help=_.bind(l.help,l),n.apis[s][a].asCurl=r[a].asCurl=_.bind(l.asCurl,l),r.apis[a]=r.operations[a]=l;var h=_.find(n.apisArray,function(t){return t.tag===e});h&&h.operationsArray.push(l)})}})}),this.isBuilt=!0,this.success&&(this.isValid=!0,this.isBuilt=!0,this.success()),this},SwaggerClient.prototype.parseUri=function(e){var t=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,i=t.exec(e);return{scheme:i[4].replace(":",""),host:i[11],port:i[12],path:i[15]}},SwaggerClient.prototype.help=function(e){var t="";return this instanceof SwaggerClient?_.forEach(this.apis,function(e,i){_.isPlainObject(e)&&(t+="operations for the '"+i+"' tag\n",_.forEach(e.operations,function(e,i){t+="  * "+i+": "+e.summary+"\n"}))}):(this instanceof OperationGroup||_.isPlainObject(this))&&(t+="operations for the '"+this.label+"' tag\n",_.forEach(this.apis,function(e,i){t+="  * "+i+": "+e.summary+"\n"})),e?t:(helpers.log(t),t)},SwaggerClient.prototype.tagFromLabel=function(e){return e},SwaggerClient.prototype.idFromOp=function(e,t,i){i&&i.operationId||(i=i||{},i.operationId=t+"_"+e);var s=i.operationId.replace(/[\s!@#$%^&*()_+=\[{\]};:<>|.\/?,\\'""-]/g,"_")||e.substring(1)+"_"+t;return s=s.replace(/((_){2,})/g,"_"),s=s.replace(/^(_)*/g,""),s=s.replace(/([_])*$/g,"")},SwaggerClient.prototype.fail=function(e){throw this.failure(e),e};


},{"./auth":2,"./helpers":4,"./http":5,"./resolver":6,"./spec-converter":7,"./types/model":8,"./types/operation":9,"./types/operationGroup":10,"lodash-compat/array/indexOf":19,"lodash-compat/collection/find":22,"lodash-compat/collection/forEach":23,"lodash-compat/function/bind":26,"lodash-compat/lang/cloneDeep":104,"lodash-compat/lang/isArray":106,"lodash-compat/lang/isFunction":107,"lodash-compat/lang/isPlainObject":110,"lodash-compat/lang/isUndefined":113}],4:[function(require,module,exports){
(function (process){
"use strict";module.exports.__bind=function(e,t){return function(){return e.apply(t,arguments)}};var log=module.exports.log=function(){log.history=log.history||[],log.history.push(arguments),console&&"test"!==process.env.NODE_ENV&&console.log(Array.prototype.slice.call(arguments)[0])};module.exports.fail=function(e){log(e)},module.exports.optionHtml=function(e,t){return'<tr><td class="optionName">'+e+":</td><td>"+t+"</td></tr>"},module.exports.typeFromJsonSchema=function(e,t){var n;return"integer"===e&&"int32"===t?n="integer":"integer"===e&&"int64"===t?n="long":"integer"===e&&"undefined"==typeof t?n="long":"string"===e&&"date-time"===t?n="date-time":"string"===e&&"date"===t?n="date":"number"===e&&"float"===t?n="float":"number"===e&&"double"===t?n="double":"number"===e&&"undefined"==typeof t?n="double":"boolean"===e?n="boolean":"string"===e&&(n="string"),n};var simpleRef=module.exports.simpleRef=function(e){return"undefined"==typeof e?null:0===e.indexOf("#/definitions/")?e.substring("#/definitions/".length):e},getStringSignature=module.exports.getStringSignature=function(e,t){var n="";return"undefined"!=typeof e.$ref?n+=simpleRef(e.$ref):"undefined"==typeof e.type?n+="object":"array"===e.type?t?n+=getStringSignature(e.items||e.$ref||{}):(n+="Array[",n+=getStringSignature(e.items||e.$ref||{}),n+="]"):n+="integer"===e.type&&"int32"===e.format?"integer":"integer"===e.type&&"int64"===e.format?"long":"integer"===e.type&&"undefined"==typeof e.format?"long":"string"===e.type&&"date-time"===e.format?"date-time":"string"===e.type&&"date"===e.format?"date":"string"===e.type&&"undefined"==typeof e.format?"string":"number"===e.type&&"float"===e.format?"float":"number"===e.type&&"double"===e.format?"double":"number"===e.type&&"undefined"==typeof e.format?"double":"boolean"===e.type?"boolean":e.$ref?simpleRef(e.$ref):e.type,n};


}).call(this,require('_process'))
},{"_process":15}],5:[function(require,module,exports){
"use strict";var helpers=require("./helpers"),jQuery=require("jquery"),request=require("superagent"),JQueryHttpClient=function(){},SuperagentHttpClient=function(){},SwaggerHttp=module.exports=function(){};SwaggerHttp.prototype.execute=function(e,t){return e&&"boolean"==typeof e.useJQuery?this.useJQuery=e.useJQuery:this.useJQuery=this.isIE8(),e&&"object"==typeof e.body&&(e.body.type&&"formData"===e.body.type?(e.contentType=!1,e.processData=!1,delete e.headers["Content-Type"]):e.body=JSON.stringify(e.body)),this.useJQuery?new JQueryHttpClient(t).execute(e):new SuperagentHttpClient(t).execute(e)},SwaggerHttp.prototype.isIE8=function(){var e=!1;if("undefined"!=typeof navigator&&navigator.userAgent){var t=navigator.userAgent.toLowerCase();if(-1!==t.indexOf("msie")){var r=parseInt(t.split("msie")[1]);8>=r&&(e=!0)}}return e},JQueryHttpClient.prototype.execute=function(e){var t=e.on,r=e;return e.type=e.method,e.cache=!1,delete e.useJQuery,e.data=e.body,delete e.body,e.complete=function(e){for(var s={},o=e.getAllResponseHeaders().split("\n"),n=0;n<o.length;n++){var u=o[n].trim();if(0!==u.length){var a=u.indexOf(":");if(-1!==a){var i=u.substring(0,a).trim(),p=u.substring(a+1).trim();s[i]=p}else s[u]=null}}var d={url:r.url,method:r.method,status:e.status,statusText:e.statusText,data:e.responseText,headers:s},y=s["content-type"]||s["Content-Type"]||null;if(y&&(0===y.indexOf("application/json")||y.indexOf("+json")>0))try{d.obj=e.responseJSON||JSON.parse(d.data)||{}}catch(l){helpers.log("unable to parse JSON content")}if(e.status>=200&&e.status<300)t.response(d);else{if(!(0===e.status||e.status>=400&&e.status<599))return t.response(d);t.error(d)}},jQuery.support.cors=!0,jQuery.ajax(e)},SuperagentHttpClient.prototype.execute=function(e){var t=e.method.toLowerCase();"delete"===t&&(t="del");var r,s=e.headers||{},o=request[t](e.url);for(r in s)o.set(r,s[r]);e.body&&o.send(e.body),o.end(function(t,r){r=r||{status:0,headers:{error:"no response from server"}};var s,o={url:e.url,method:e.method,headers:r.headers};!t&&r.error&&(t=r.error),t&&e.on&&e.on.error?(o.obj=t,o.status=r?r.status:500,o.statusText=r?r.text:t.message,s=e.on.error):r&&e.on&&e.on.response&&(o.obj="undefined"!=typeof r.body?r.body:r.text,o.status=r.status,o.statusText=r.text,s=e.on.response),o.data=o.statusText,s&&s(o)})};


},{"./helpers":4,"jquery":18,"superagent":122}],6:[function(require,module,exports){
"use strict";var SwaggerHttp=require("./http"),Resolver=module.exports=function(){};Resolver.prototype.resolve=function(e,r,i){this.scope=i||this,this.iteration=this.iteration||0;var s,o,t,n,a,l=0,f={},h={},v={};for(o in e.definitions){var p=e.definitions[o];for(a in p.properties)n=p.properties[a],this.resolveTo(n,v)}for(o in e.paths){var c,u,y;t=e.paths[o];for(c in t)if("$ref"===c)this.resolveInline(e,t,v,h);else{u=t[c];var d,g=u.parameters;for(d in g){var b=g[d];"body"===b["in"]&&b.schema&&this.resolveTo(b.schema,v),b.$ref&&this.resolveInline(e,b,v,h)}for(y in u.responses){var j=u.responses[y];"object"==typeof j&&j.$ref&&this.resolveInline(e,j,v,h),j.schema&&j.schema.$ref&&this.resolveTo(j.schema,v)}}}var A={},m=0;for(o in v){var $=o.split("#");2===$.length?(s=$[0],t=$[1],Array.isArray(A[s])||(A[s]=[],m+=1),A[s].push(t)):(Array.isArray(A[o])||(A[o]=[],m+=1),A[o].push(null))}for(o in A){var O=this,x=A[o];s=o;var R={useJQuery:!1,url:s,method:"get",headers:{accept:this.scope.swaggerRequestHeaders||"application/json"},on:{error:function(){l+=1;var i;for(i=0;i<x.length;i++){var o=s+"#"+x[i];h[o]=null}l===m&&O.finish(e,v,f,h,r)},response:function(i){var t,n,a=i.obj;if(null===a||0===Object.keys(a).length)try{a=JSON.parse(i.data)}catch(p){a={}}for(l+=1,t=0;t<x.length;t++){var c=x[t];if(null==c)f[o]={name:o,obj:a};else{var u=a,y=c.split("/");for(n=0;n<y.length;n++){var d=y[n];if(-1!==d.indexOf("~1")&&(d=y[n].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==d.charAt(0)&&(d="/"+d)),"undefined"==typeof u)break;d.length>0&&(u=u[d])}var g=s+"#"+c,b=y[n-1];"undefined"!=typeof u?f[g]={name:b,obj:u}:h[g]=null}}l===m&&O.finish(e,v,f,h,r)}}};i&&i.clientAuthorizations&&i.clientAuthorizations.apply(R),(new SwaggerHttp).execute(R)}0===Object.keys(A).length&&r.call(this.scope,e,h)},Resolver.prototype.finish=function(e,r,i,s,o){var t;for(t in r){var n,a=r[t];for(n=0;n<a.length;n++){var l=i[a[n].obj.$ref];if(l)if(e.definitions||(e.definitions={}),"$ref"===a[n].resolveAs)e.definitions[l.name]=l.obj,a[n].obj.$ref="#/definitions/"+l.name;else if("inline"===a[n].resolveAs){var f,h=a[n].obj;delete h.$ref;for(f in l.obj)h[f]=l.obj[f]}}}2===this.iteration?o.call(this.scope,e,s):(this.iteration+=1,this.resolve(e,o,this.scope))},Resolver.prototype.resolveInline=function(e,r,i,s){var o=r.$ref;if(o){if(0===o.indexOf("http"))Array.isArray(i[o])?i[o].push({obj:r,resolveAs:"inline"}):i[o]=[{obj:r,resolveAs:"inline"}];else if(0===o.indexOf("#")){var t,n=o.substring(1),a=n.split("/"),l=e;for(t=0;t<a.length;t++){var f=a[t];f.length>0&&(l=l[f])}if(l){delete r.$ref;var h;for(h in l)r[h]=l[h]}else s[o]=null}}else"array"===r.type&&this.resolveTo(r.items,i)},Resolver.prototype.resolveTo=function(e,r){var i=e.$ref;if(i)0===i.indexOf("http")&&(Array.isArray(r[i])?r[i].push({obj:e,resolveAs:"$ref"}):r[i]=[{obj:e,resolveAs:"$ref"}]);else if("array"===e.type){var s=e.items;this.resolveTo(s,r)}};


},{"./http":5}],7:[function(require,module,exports){
"use strict";var SwaggerClient=require("./client"),SwaggerHttp=require("./http"),SwaggerSpecConverter=module.exports=function(){this.errors=[],this.warnings=[],this.modelMap={}};SwaggerSpecConverter.prototype.setDocumentationLocation=function(e){this.docLocation=e},SwaggerSpecConverter.prototype.convert=function(e,t){if(!e||!Array.isArray(e.apis))return this.finish(t,null);var r={swagger:"2.0"};r.originalVersion=e.swaggerVersion,this.apiInfo(e,r),this.securityDefinitions(e,r),e.basePath&&this.setDocumentationLocation(e.basePath);var i,s=!1;for(i=0;i<e.apis.length;i++){var o=e.apis[i];Array.isArray(o.operations)&&(s=!0)}s?(this.declaration(e,r),this.finish(t,r)):this.resourceListing(e,r,t)},SwaggerSpecConverter.prototype.declaration=function(e,t){var r,i;if(e.apis){{e.basePath}if(0===e.basePath.indexOf("http://")){var s=e.basePath.substring("http://".length),o=s.indexOf("/");o>0?(t.host=s.substring(0,o),t.basePath=s.substring(o)):(t.host=s,t.basePath="/")}var n;if(e.authorizations&&(n=e.authorizations),e.consumes&&(t.consumes=e.consumes),e.produces&&(t.produces=e.produces),"object"==typeof e)for(r in e.models){var a=e.models[r],p=a.id||r;this.modelMap[p]=r}for(i=0;i<e.apis.length;i++){var c=e.apis[i],u=c.path,f=c.operations;this.operations(u,e.resourcePath,f,n,t)}var l=e.models;this.models(l,t)}},SwaggerSpecConverter.prototype.models=function(e,t){if("object"==typeof e){var r;t.definitions=t.definitions||{};for(r in e){var i,s=e[r],o=[],n={properties:{}};for(i in s.properties){var a=s.properties[i],p={};this.dataType(a,p),a.description&&(p.description=a.description),a["enum"]&&(p["enum"]=a["enum"]),"boolean"==typeof a.required&&a.required===!0&&o.push(i),"string"==typeof a.required&&"true"===a.required&&o.push(i),n.properties[i]=p}o.length>0&&(n["enum"]=o),t.definitions[r]=n}}},SwaggerSpecConverter.prototype.extractTag=function(e){var t=e||"default";return(0===t.indexOf("http:")||0===t.indexOf("https:"))&&(t=t.split(["/"]),t=t[t.length-1].substring()),t.replace("/","")},SwaggerSpecConverter.prototype.operations=function(e,t,r,i,s){if(Array.isArray(r)){var o;s.paths||(s.paths={});var n=s.paths[e]||{},a=this.extractTag(t);s.tags=s.tags||[];var p=!1;for(o=0;o<s.tags.length;o++){var c=s.tags[o];c.name===a&&(p=!0)}for(p||s.tags.push({name:a}),o=0;o<r.length;o++){var u=r[o],f=(u.method||u.httpMethod).toLowerCase(),l={tags:[a]},h=u.authorizations;if(h&&0===Object.keys(h).length&&(h=i),"undefined"!=typeof h)for(var m in h){l.security=l.security||[];var g=h[m];if(g){var d=[];for(var y in g)d.push(g[y].scope);var v={};v[m]=d,l.security.push(v)}else{var v={};v[m]=[],l.security.push(v)}}u.consumes?l.consumes=u.consumes:s.consumes&&(l.consumes=s.consumes),u.produces?l.produces=u.produces:s.produces&&(l.produces=s.produces),u.summary&&(l.summary=u.summary),u.notes&&(l.description=u.notes),u.nickname&&(l.operationId=u.nickname),u.deprecated&&(l.deprecated=u.deprecated),this.authorizations(h,s),this.parameters(l,u.parameters,s),this.responseMessages(l,u,s),n[f]=l}s.paths[e]=n}},SwaggerSpecConverter.prototype.responseMessages=function(e,t,r){if("object"==typeof t){var i={};this.dataType(t,i),i.schema||(i={schema:i}),e.responses=e.responses||{};var s=!1;if(Array.isArray(t.responseMessages)){var o,n=t.responseMessages;for(o=0;o<n.length;o++){var a=n[o],p={description:a.message};200===a.code&&(s=!0),e.responses[""+a.code]=p}}s?e.responses["default"]=i:e.responses[200]=i}},SwaggerSpecConverter.prototype.authorizations=function(e,t){},SwaggerSpecConverter.prototype.parameters=function(e,t,r){if(Array.isArray(t)){var i;for(i=0;i<t.length;i++){var s=t[i],o={};if(o.name=s.name,o.description=s.description,o.required=s.required,o["in"]=s.paramType,"body"===o["in"]&&(o.name="body"),"form"===o["in"]&&(o["in"]="formData"),s.allowMultiple===!0||"true"===s.allowMultiple){var n={};if(this.dataType(s,n),o.type="array",o.items=n,s.allowableValues){var a=s.allowableValues;"LIST"===a.valueType&&(o["enum"]=a.values)}}else this.dataType(s,o);e.parameters=e.parameters||[],e.parameters.push(o)}}},SwaggerSpecConverter.prototype.dataType=function(e,t){if("object"==typeof e){e.minimum&&(t.minimum=e.minimum),e.maximum&&(t.maximum=e.maximum),e.defaultValue&&(t["default"]=e.defaultValue);var r=this.toJsonSchema(e);r&&(t=t||{},r.type&&(t.type=r.type),r.format&&(t.format=r.format),r.$ref&&(t.schema={$ref:r.$ref}),r.items&&(t.items=r.items))}},SwaggerSpecConverter.prototype.toJsonSchema=function(e){if(!e)return"object";var t=e.type||e.dataType||e.responseClass||"",r=t.toLowerCase(),i=(e.format||"").toLowerCase();if(0===r.indexOf("list[")){var s=t.substring(5,t.length-1),o=this.toJsonSchema({type:s});return{type:"array",items:o}}if("int"===r||"integer"===r&&"int32"===i)return{type:"integer",format:"int32"};if("long"===r||"integer"===r&&"int64"===i)return{type:"integer",format:"int64"};if("integer"===r)return{type:"integer",format:"int64"};if("float"===r||"number"===r&&"float"===i)return{type:"number",format:"float"};if("double"===r||"number"===r&&"double"===i)return{type:"number",format:"double"};if("string"===r&&"date-time"===i||"date"===r)return{type:"string",format:"date-time"};if("string"===r)return{type:"string"};if("file"===r)return{type:"file"};if("boolean"===r)return{type:"boolean"};if("array"===r||"list"===r){if(e.items){var n=this.toJsonSchema(e.items);return{type:"array",items:n}}return{type:"array",items:{type:"object"}}}return e.$ref?{$ref:"#/definitions/"+this.modelMap[e.$ref]||e.$ref}:{$ref:"#/definitions/"+this.modelMap[e.type]||e.type}},SwaggerSpecConverter.prototype.resourceListing=function(e,t,r){var i,s=0,o=this,n=e.apis.length,a=t;for(0===n&&this.finish(r,t),i=0;n>i;i++){var p=e.apis[i],c=p.path,u=this.getAbsolutePath(e.swaggerVersion,this.docLocation,c);p.description&&(t.tags=t.tags||[],t.tags.push({name:this.extractTag(p.path),description:p.description||""}));var f={url:u,headers:{accept:"application/json"},on:{},method:"get"};f.on.response=function(e){s+=1;var t=e.obj;if("undefined"==typeof t||null===t)try{t=JSON.parse(e.statusText)}catch(i){}t&&o.declaration(t,a),s===n&&o.finish(r,a)},f.on.error=function(e){console.error(e),s+=1,s===n&&o.finish(r,a)},(new SwaggerHttp).execute(f)}},SwaggerSpecConverter.prototype.getAbsolutePath=function(e,t,r){if("1.0"===e&&t.endsWith(".json")){var i=t.lastIndexOf("/");i>0&&(t=t.substring(0,i))}var s=t;return 0===r.indexOf("http://")||0===r.indexOf("https://")?s=r:(t.endsWith("/")&&(s=t.substring(0,t.length-1)),s+=r),s=s.replace("{format}","json")},SwaggerSpecConverter.prototype.securityDefinitions=function(e,t){if(e.authorizations){var r;for(r in e.authorizations){var i=!1,s={},o=e.authorizations[r];if("apiKey"===o.type)s.type="apiKey",s["in"]=o.passAs,s.name=o.keyname||r,i=!0;else if("oauth2"===o.type){var n,a=o.scopes||[],p={};for(n in a){var c=a[n];p[c.scope]=c.description}if(s.type="oauth2",n>0&&(s.scopes=p),o.grantTypes){if(o.grantTypes.implicit){var u=o.grantTypes.implicit;s.flow="implicit",s.authorizationUrl=u.loginEndpoint,i=!0}if(o.grantTypes.authorization_code&&!s.flow){var f=o.grantTypes.authorization_code;s.flow="accessCode",s.authorizationUrl=f.tokenRequestEndpoint.url,s.tokenUrl=f.tokenEndpoint.url,i=!0}}}i&&(t.securityDefinitions=t.securityDefinitions||{},t.securityDefinitions[r]=s)}}},SwaggerSpecConverter.prototype.apiInfo=function(e,t){if(e.info){var r=e.info;t.info={},r.contact&&(t.info.contact={},t.info.contact.email=r.contact),r.description&&(t.info.description=r.description),r.title&&(t.info.title=r.title),r.termsOfServiceUrl&&(t.info.termsOfService=r.termsOfServiceUrl),(r.license||r.licenseUrl)&&(t.license={},r.license&&(t.license.name=r.license),r.licenseUrl&&(t.license.url=r.licenseUrl))}else this.warnings.push("missing info section")},SwaggerSpecConverter.prototype.finish=function(e,t){e(t)};


},{"./client":3,"./http":5}],8:[function(require,module,exports){
"use strict";var _={forEach:require("lodash-compat/collection/forEach"),indexOf:require("lodash-compat/array/indexOf"),isArray:require("lodash-compat/lang/isArray"),isPlainObject:require("lodash-compat/lang/isPlainObject"),isString:require("lodash-compat/lang/isString"),isUndefined:require("lodash-compat/lang/isUndefined"),keys:require("lodash-compat/object/keys"),map:require("lodash-compat/collection/map")},helpers=require("../helpers"),applyParameterMacro=function(e,i){return e.api&&e.api.parameterMacro?e.api.parameterMacro(e,i):i.defaultValue},applyModelPropertyMacro=function(e,i){return e.api&&e.api.modelPropertyMacro?e.api.modelPropertyMacro(e,i):i["default"]},Model=module.exports=function(e,i,t){return this.definition=i||{},this.isArray="array"===i.type,this.models=t||{},this.name=i.title||e||"Inline Model",this},schemaToHTML=function(e,i,t){for(var n='<span class="strong">',s="</span>",r={},a=[],o=0,p=function(e,i,n){var s,a=i;return e.$ref?(a=e.title||helpers.simpleRef(e.$ref),s=t[a]):_.isUndefined(i)&&(a=e.title||"Inline Model "+ ++o,s=new Model(a,e,t)),n!==!0&&(r[a]=_.isUndefined(s)?{}:s.definition),a},l=function(e){var i='<span class="propType">',t=e.type||"object";return e.$ref?i+=p(e,helpers.simpleRef(e.$ref)):"object"===t?i+=_.isUndefined(e.properties)?"object":p(e):"array"===t?(i+="Array[",_.isArray(e.items)?i+=_.map(e.items,p).join(","):_.isPlainObject(e.items)?i+=_.isUndefined(e.items.$ref)?_.isUndefined(e.items.type)||-1!==_.indexOf(["array","object"],e.items.type)?p(e.items):e.items.type:p(e.items,helpers.simpleRef(e.items.$ref)):(helpers.log("Array type's 'items' schema is not an array or an object, cannot process"),i+="object"),i+="]"):i+=e.type,i+="</span>"},m=function(e,i){var t="",n=e.type||"object",s="array"===n;switch(s&&(n=_.isPlainObject(e.items)&&!_.isUndefined(e.items.type)?e.items.type:"object"),_.isUndefined(e["default"])||(t+=helpers.optionHtml("Default",e["default"])),n){case"string":e.minLength&&(t+=helpers.optionHtml("Min. Length",e.minLength)),e.maxLength&&(t+=helpers.optionHtml("Max. Length",e.maxLength)),e.pattern&&(t+=helpers.optionHtml("Reg. Exp.",e.pattern));break;case"integer":case"number":e.minimum&&(t+=helpers.optionHtml("Min. Value",e.minimum)),e.exclusiveMinimum&&(t+=helpers.optionHtml("Exclusive Min.","true")),e.maximum&&(t+=helpers.optionHtml("Max. Value",e.maximum)),e.exclusiveMaximum&&(t+=helpers.optionHtml("Exclusive Max.","true")),e.multipleOf&&(t+=helpers.optionHtml("Multiple Of",e.multipleOf))}if(s&&(e.minItems&&(t+=helpers.optionHtml("Min. Items",e.minItems)),e.maxItems&&(t+=helpers.optionHtml("Max. Items",e.maxItems)),e.uniqueItems&&(t+=helpers.optionHtml("Unique Items","true")),e.collectionFormat&&(t+=helpers.optionHtml("Coll. Format",e.collectionFormat))),_.isUndefined(e.items)&&_.isArray(e["enum"])){var r;r="number"===n||"integer"===n?e["enum"].join(", "):'"'+e["enum"].join('", "')+'"',t+=helpers.optionHtml("Enum",r)}return t.length>0&&(i='<span class="propWrap">'+i+'<table class="optionsWrapper"><tr><th colspan="2">'+n+"</th></tr>"+t+"</table></span>"),i},d=function(e,i){var t=e.type||"object",r="array"===e.type,o=n+i+" "+(r?"[":"{")+s;return i&&a.push(i),r?_.isArray(e.items)?o+="<div>"+_.map(e.items,function(e){var i=e.type||"object";return _.isUndefined(e.$ref)?_.indexOf(["array","object"],i)>-1?"object"===i&&_.isUndefined(e.properties)?"object":p(e):m(e,i):p(e,helpers.simpleRef(e.$ref))}).join(",</div><div>"):_.isPlainObject(e.items)?o+=_.isUndefined(e.items.$ref)?_.indexOf(["array","object"],e.items.type||"object")>-1?(_.isUndefined(e.items.type)||"object"===e.items.type)&&_.isUndefined(e.items.properties)?"<div>object</div>":"<div>"+p(e.items)+"</div>":"<div>"+m(e.items,e.items.type)+"</div>":"<div>"+p(e.items,helpers.simpleRef(e.items.$ref))+"</div>":(helpers.log("Array type's 'items' property is not an array or an object, cannot process"),o+="<div>object</div>"):e.$ref?o+="<div>"+p(e,i)+"</div>":"object"===t?(o+="<div>",_.isPlainObject(e.properties)&&(o+=_.map(e.properties,function(i,t){var n=_.indexOf(e.required||[],t)>-1,s='<span class="propName '+n+'">'+t+"</span> (";return s+=l(i),n||(s+=', <span class="propOptKey">optional</span>'),s+=")",_.isUndefined(i.description)||(s+=": "+i.description),i["enum"]&&(s+=' = <span class="propVals">[\''+i["enum"].join("' or '")+"']</span>"),m(i,s)}).join(",</div><div>")),o+="</div>"):o="<div>"+m(e,t)+"</div>",o+n+(r?"]":"}")+s},c=d(i,e);_.keys(r).length>0;)_.forEach(r,function(e,i){var t=_.indexOf(a,i)>-1;delete r[i],t||(a.push(i),c+="<br />"+d(e,i))});return c},schemaToJSON=function(e,i,t){var n,s,r=e.type||"object";return e.example?s=e.example:_.isUndefined(e.items)&&_.isArray(e["enum"])&&(s=e["enum"][0]),_.isUndefined(s)&&(e.$ref?(n=i[helpers.simpleRef(e.$ref)],_.isUndefined(n)||(_.isUndefined(t[n.name])?(t[n.name]=n,s=schemaToJSON(n.definition,i,t),delete t[n.name]):s="array"===n.type?[]:{})):_.isUndefined(e["default"])?"date-time"===r?s=(new Date).toISOString():"date"===r?s=(new Date).toISOString().split("T")[0]:"string"===r?s="string":"integer"===r?s=0:"long"===r?s=0:"float"===r?s=0:"double"===r?s=0:"boolean"===r?s=!0:"number"===r?s=0:"object"===r?(s={},_.forEach(e.properties,function(e,n){s[n]=schemaToJSON(e,i,t)})):"array"===r&&(s=[],_.isArray(e.items)?_.forEach(e.items,function(e){s.push(schemaToJSON(e,i,t))}):_.isPlainObject(e.items)?s.push(schemaToJSON(e.items,i,t)):_.isUndefined(e.items)?s.push({}):helpers.log("Array type's 'items' property is not an array or an object, cannot process")):s=e["default"]),s};Model.prototype.createJSONSample=Model.prototype.getSampleValue=function(e){return e=e||{},e[this.name]=this,this.examples&&_.isPlainObject(this.examples)&&this.examples["application/json"]?(this.definition.example=this.examples["application/json"],_.isString(this.definition.example)&&(this.definition.example=JSON.parse(this.definition.example))):this.definition.example=this.examples,schemaToJSON(this.definition,this.models,e)},Model.prototype.getMockSignature=function(){return schemaToHTML(this.name,this.definition,this.models)};


},{"../helpers":4,"lodash-compat/array/indexOf":19,"lodash-compat/collection/forEach":23,"lodash-compat/collection/map":24,"lodash-compat/lang/isArray":106,"lodash-compat/lang/isPlainObject":110,"lodash-compat/lang/isString":111,"lodash-compat/lang/isUndefined":113,"lodash-compat/object/keys":114}],9:[function(require,module,exports){
"use strict";var _={isUndefined:require("lodash-compat/lang/isUndefined")},helpers=require("../helpers"),Model=require("./model"),SwaggerHttp=require("../http"),Operation=module.exports=function(e,t,r,s,n,i,a,o,p){var h=[];if(e=e||{},i=i||{},this.authorizations=i.security,this.basePath=e.basePath||"/",this.clientAuthorizations=p,this.consumes=i.consumes,this.deprecated=i.deprecated,this.description=i.description,this.host=e.host||"localhost",this.method=s||h.push("Operation "+r+" is missing method."),this.models=o||{},this.nickname=r||h.push("Operations must have a nickname."),this.operation=i,this.operations={},this.parameters=null!==i?i.parameters||[]:{},this.parent=e,this.path=n||h.push("Operation "+this.nickname+" is missing path."),this.produces=i.produces,this.responses=i.responses||{},this.scheme=t||e.scheme||"http",this.schemes=e.schemes,this.security=i.security,this.summary=i.summary||"",this.type=null,this.useJQuery=e.useJQuery,"string"==typeof this.deprecated)switch(this.deprecated.toLowerCase()){case"true":case"yes":case"1":this.deprecated=!0;break;case"false":case"no":case"0":case null:this.deprecated=!1;break;default:this.deprecated=Boolean(this.deprecated)}var u,l;if(a){var d;for(d in this.definitions)l=new Model(d,a[d],this.models),l&&(this.models[d]=l)}for(u=0;u<this.parameters.length;u++){var m=this.parameters[u];"array"===m.type&&(m.isList=!0,m.allowMultiple=!0);var f=this.getType(m);if(f&&"boolean"===f.toString().toLowerCase()&&(m.allowableValues={},m.isList=!0,m["enum"]=["true","false"]),"undefined"!=typeof m["enum"]){var c;for(m.allowableValues={},m.allowableValues.values=[],m.allowableValues.descriptiveValues=[],c=0;c<m["enum"].length;c++){var y=m["enum"][c],g=y===m["default"]?!0:!1;m.allowableValues.values.push(y),m.allowableValues.descriptiveValues.push({value:y,isDefault:g})}}"array"===m.type&&(f=[f],"undefined"==typeof m.allowableValues&&(delete m.isList,delete m.allowMultiple)),m.signature=this.getModelSignature(f,this.models).toString(),m.sampleJSON=this.getModelSampleJSON(f,this.models),m.responseClassSignature=m.signature}var v,b,O=this.responses;if(O[200]?(b=O[200],v="200"):O[201]?(b=O[201],v="201"):O[202]?(b=O[202],v="202"):O[203]?(b=O[203],v="203"):O[204]?(b=O[204],v="204"):O[205]?(b=O[205],v="205"):O[206]?(b=O[206],v="206"):O["default"]&&(b=O["default"],v="default"),b&&b.schema){var w,C=this.resolveModel(b.schema,a);delete O[v],C?(this.successResponse={},w=this.successResponse[v]=C):b.schema.type&&"object"!==b.schema.type&&"array"!==b.schema.type?(this.successResponse={},w=this.successResponse[v]=b.schema):(this.successResponse={},w=this.successResponse[v]=new Model(void 0,b.schema||{},this.models)),w&&(b.description&&(w.description=b.description),b.examples&&(w.examples=b.examples),b.headers&&(w.headers=b.headers)),this.type=b}return h.length>0&&this.resource&&this.resource.api&&this.resource.api.fail&&this.resource.api.fail(h),this};Operation.prototype.getType=function(e){var t,r=e.type,s=e.format,n=!1;"integer"===r&&"int32"===s?t="integer":"integer"===r&&"int64"===s?t="long":"integer"===r?t="integer":"string"===r?t="date-time"===s?"date-time":"date"===s?"date":"string":"number"===r&&"float"===s?t="float":"number"===r&&"double"===s?t="double":"number"===r?t="double":"boolean"===r?t="boolean":"array"===r&&(n=!0,e.items&&(t=this.getType(e.items))),e.$ref&&(t=e.$ref);var i=e.schema;if(i){var a=i.$ref;return a?(a=helpers.simpleRef(a),n?[a]:a):this.getType(i)}return n?[t]:t},Operation.prototype.resolveModel=function(e,t){if("undefined"!=typeof e.$ref){var r=e.$ref;if(0===r.indexOf("#/definitions/")&&(r=r.substring("#/definitions/".length)),t[r])return new Model(r,t[r],this.models)}else if("object"===e.type||_.isUndefined(e.type))return new Model(void 0,e,this.models);return null},Operation.prototype.help=function(e){for(var t=this.nickname+": "+this.summary+"\n",r=0;r<this.parameters.length;r++){var s=this.parameters[r],n=s.signature;t+="\n  * "+s.name+" ("+n+"): "+s.description}return"undefined"==typeof e&&helpers.log(t),t},Operation.prototype.getModelSignature=function(e,t){var r,s;return e instanceof Array?(s=!0,e=e[0]):"undefined"==typeof e&&(e="undefined"),r="string"===e?!0:s&&t[s]||t[e]?!1:!0,r?s?"Array["+e+"]":e.toString():s?"Array["+t[e].getMockSignature()+"]":t[e].getMockSignature()},Operation.prototype.supportHeaderParams=function(){return!0},Operation.prototype.supportedSubmitMethods=function(){return this.parent.supportedSubmitMethods},Operation.prototype.getHeaderParams=function(e){for(var t=this.setContentTypes(e,{}),r=0;r<this.parameters.length;r++){var s=this.parameters[r];if("undefined"!=typeof e[s.name]&&e[s.name].length&&"header"===s["in"]){var n=e[s.name].shift(),i=n;Array.isArray(i)&&(i=i.toString()),t[s.name]=i}}return t},Operation.prototype.urlify=function(e){for(var t={},r=this.path,s="",n=0;n<this.parameters.length;n++){var i=this.parameters[n];if("undefined"!=typeof e[i.name]&&e[i.name].length)if("path"===i["in"]){var a=new RegExp("{"+i.name+"}","gi"),o=e[i.name].shift();o=Array.isArray(o)?this.encodePathCollection(i.collectionFormat,i.name,o):this.encodePathParam(o),r=r.replace(a,o)}else if("query"===i["in"]&&"undefined"!=typeof e[i.name])if(s+=""===s?"?":"&","undefined"!=typeof i.collectionFormat){var p=e[i.name].shift();s+=Array.isArray(p)?this.encodeQueryCollection(i.collectionFormat,i.name,p):this.encodeQueryParam(i.name)+"="+this.encodeQueryParam(p)}else s+=i.name+"="+this.encodeQueryParam(e[i.name].shift());else"formData"===i["in"]&&(t[i.name]=e[i.name].shift())}var h=this.scheme+"://"+this.host;return"/"!==this.basePath&&(h+=this.basePath),h+r+s},Operation.prototype.getMissingParams=function(e){var t,r=[];for(t=0;t<this.parameters.length;t++){var s=this.parameters[t];s.required===!0&&"undefined"==typeof e[s.name]&&(r=s.name)}return r},Operation.prototype.getBody=function(e,t,r){for(var s,n,i,a={},o=0;o<this.parameters.length;o++){var p=this.parameters[o];"undefined"!=typeof t[p.name]&&t[p.name].length&&("body"===p["in"]?s=t[p.name].shift():"formData"===p["in"]&&(void 0===a[p.name]&&(a[p.name]=[]),a[p.name].push(t[p.name].shift())))}if("application/x-www-form-urlencoded"===e["Content-Type"]){for(var h="",o=0;o<this.parameters.length;o++){var p=this.parameters[o];if("formData"===p["in"]&&"undefined"!=typeof a[p.name]&&a[p.name].length){var u=a[p.name].shift();""!==h&&(h+="&"),h+=p.name+"="+encodeURIComponent(u)}}s=h}else if(e["Content-Type"]&&e["Content-Type"].indexOf("multipart/form-data")>=0&&r.useJQuery){var l=new FormData;l.type="formData";for(n in a)i=t[n],"undefined"!=typeof i&&("file"===i.type&&i.value?(delete e["Content-Type"],l.append(n,i.value)):l.append(n,i));s=l}return s},Operation.prototype.getModelSampleJSON=function(e,t){var r,s,n;if(s=e instanceof Array,r=t[e]?!1:!0,n=r?void 0:t[e].createJSONSample()){if(n=s?[n]:n,"string"==typeof n)return n;if("object"==typeof n){var i=n;if(n instanceof Array&&n.length>0&&(i=n[0]),i.nodeName){var a=(new XMLSerializer).serializeToString(i);return this.formatXml(a)}return JSON.stringify(n,null,2)}return n}},Operation.prototype["do"]=function(e,t,r,s,n){return this.execute(e,t,r,s,n)},Operation.prototype.execute=function(e,t,r,s,n){var i,a,o=e||{},p={};"object"==typeof t&&(p=t,i=r,a=s),"function"==typeof t&&(i=t,a=r),i=i||helpers.log,a=a||helpers.log,p.useJQuery&&(this.useJQuery=p.useJQuery);var h=this.getMissingParams(o);if(h.length>0){var u="missing required params: "+h;return void helpers.fail(u)}var l,d=this.getHeaderParams(o),m=this.setContentTypes(o,p),f={};for(l in d)f[l]=d[l];for(l in m)f[l]=m[l];var c=this.getBody(f,o,p),y=this.urlify(o);if(y.indexOf(".{format}")>0&&f){var g=f.Accept||f.accept;g&&g.indexOf("json")>0?y=y.replace(".{format}",".json"):g&&g.indexOf("xml")>0&&(y=y.replace(".{format}",".xml"))}var v={url:y,method:this.method.toUpperCase(),body:c,useJQuery:this.useJQuery,headers:f,on:{response:function(e){return i(e,n)},error:function(e){return a(e,n)}}};return this.clientAuthorizations.apply(v,this.operation.security),p.mock===!0?v:void(new SwaggerHttp).execute(v,p)},Operation.prototype.setContentTypes=function(e,t){var r,s,n="application/json",i=this.parameters,a=e.parameterContentType||"application/json",o=[],p=[],h={};for(s=0;s<i.length;s++){var u=i[s];if("formData"===u["in"])"file"===u.type?o.push(u):p.push(u);else if("header"===u["in"]&&t){var l=u.name,d=t[u.name];"undefined"!=typeof t[u.name]&&(h[l]=d)}else"body"===u["in"]&&"undefined"!=typeof e[u.name]&&(r=e[u.name])}return!r||"post"!==this.method&&"put"!==this.method&&"patch"!==this.method&&"delete"!==this.method?p.length>0?a=t.requestContentType?t.requestContentType:o.length>0?"multipart/form-data":"application/x-www-form-urlencoded":"DELETE"===this.type?r="{}":"DELETE"!==this.type&&(a=null):t.requestContentType&&(a=t.requestContentType),a&&this.consumes&&-1===this.consumes.indexOf(a)&&helpers.log("server doesn't consume "+a+", try "+JSON.stringify(this.consumes)),n=t.responseContentType?t.responseContentType:"application/json",n&&this.produces&&-1===this.produces.indexOf(n)&&helpers.log("server can't produce "+n),(a&&""!==r||"application/x-www-form-urlencoded"===a)&&(h["Content-Type"]=a),n&&(h.Accept=n),h},Operation.prototype.asCurl=function(e){var t=this.execute(e,{mock:!0});this.clientAuthorizations.apply(t);var r=[];if(r.push("-X "+this.method.toUpperCase()),t.headers){var s;for(s in t.headers)r.push('--header "'+s+": "+t.headers[s]+'"')}if(t.body){var n;n="object"==typeof t.body?JSON.stringify(t.body):t.body,r.push('-d "'+n.replace(/"/g,'\\"')+'"')}return"curl "+r.join(" ")+' "'+t.url+'"'},Operation.prototype.encodePathCollection=function(e,t,r){var s,n="",i="";for(i="ssv"===e?"%20":"tsv"===e?"\\t":"pipes"===e?"|":",",s=0;s<r.length;s++)0===s?n=this.encodeQueryParam(r[s]):n+=i+this.encodeQueryParam(r[s]);return n},Operation.prototype.encodeQueryCollection=function(e,t,r){var s,n="";if("default"===e||"multi"===e)for(s=0;s<r.length;s++)s>0&&(n+="&"),n+=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[s]);else{var i="";if("csv"===e)i=",";else if("ssv"===e)i="%20";else if("tsv"===e)i="\\t";else if("pipes"===e)i="|";else if("brackets"===e)for(s=0;s<r.length;s++)0!==s&&(n+="&"),n+=this.encodeQueryParam(t)+"[]="+this.encodeQueryParam(r[s]);if(""!==i)for(s=0;s<r.length;s++)0===s?n=this.encodeQueryParam(t)+"="+this.encodeQueryParam(r[s]):n+=i+this.encodeQueryParam(r[s])}return n},Operation.prototype.encodeQueryParam=function(e){return encodeURIComponent(e)},Operation.prototype.encodePathParam=function(e){var t,r,s,n;if(e=e.toString(),-1===e.indexOf("/"))return encodeURIComponent(e);for(r=e.split("/"),t=[],s=0,n=r.length;n>s;s++)t.push(encodeURIComponent(r[s]));return t.join("/")};


},{"../helpers":4,"../http":5,"./model":8,"lodash-compat/lang/isUndefined":113}],10:[function(require,module,exports){
...
},{"../internal/baseIndexOf":45,"../internal/binaryIndex":59}],20:[function(require,module,exports){
...
},{"../internal/LazyWrapper":28,"../internal/LodashWrapper":29,"../internal/baseLodash":50,"../internal/isObjectLike":91,"../internal/wrapperClone":103,"../lang/isArray":106}],22:[function(require,module,exports){
...
},{"../internal/baseEach":38,"../internal/createFind":69}],23:[function(require,module,exports){
...
},{"../internal/arrayEach":31,"../internal/baseEach":38,"../internal/createForEach":70}],24:[function(require,module,exports){
...
},{"../internal/arrayMap":32,"../internal/baseCallback":34,"../internal/baseMap":51,"../lang/isArray":106}],25:[function(require,module,exports){
...
},{"../lang/isNative":108}],26:[function(require,module,exports){
...
},{"../internal/createWrapper":73,"../internal/replaceHolders":97,"./restParam":27}],27:[function(require,module,exports){
...
function LazyWrapper(e){this.__wrapped__=e,this.__actions__=null,this.__dir__=1,this.__dropCount__=0,this.__filtered__=!1,this.__iteratees__=null,this.__takeCount__=POSITIVE_INFINITY,this.__views__=null}var baseCreate=require("./baseCreate"),baseLodash=require("./baseLodash"),POSITIVE_INFINITY=Number.POSITIVE_INFINITY;LazyWrapper.prototype=baseCreate(baseLodash.prototype),LazyWrapper.prototype.constructor=LazyWrapper,module.exports=LazyWrapper;


},{"./baseCreate":37,"./baseLodash":50}],29:[function(require,module,exports){
...
},{"./baseCreate":37,"./baseLodash":50}],30:[function(require,module,exports){
...
},{"../lang/isNative":108,"../object/keys":114,"./baseCopy":36,"./getSymbols":80}],34:[function(require,module,exports){
...
},{"../utility/identity":119,"../utility/property":121,"./baseMatches":52,"./baseMatchesProperty":53,"./bindCallback":61}],35:[function(require,module,exports){
...
},{"../lang/isArray":106,"../lang/isObject":109,"./arrayCopy":30,"./arrayEach":31,"./baseAssign":33,"./baseForOwn":43,"./initCloneArray":82,"./initCloneByTag":83,"./initCloneObject":84,"./isHostObject":86}],36:[function(require,module,exports){
...
},{"../lang/isObject":109}],38:[function(require,module,exports){
...
},{"./baseForOwn":43,"./createBaseEach":65}],39:[function(require,module,exports){
...
},{"./createBaseFor":66}],42:[function(require,module,exports){
...
},{"../object/keysIn":115,"./baseFor":41}],43:[function(require,module,exports){
...
},{"../object/keys":114,"./baseFor":41}],44:[function(require,module,exports){
...
},{"./toObject":101}],45:[function(require,module,exports){
...
},{"./indexOfNaN":81}],46:[function(require,module,exports){
...
},{"./baseIsEqualDeep":47}],47:[function(require,module,exports){
...
},{"../lang/isArray":106,"../lang/isTypedArray":112,"./equalArrays":74,"./equalByTag":75,"./equalObjects":76,"./isHostObject":86}],48:[function(require,module,exports){
...
},{"./baseIsEqual":46}],50:[function(require,module,exports){
...
},{"./baseEach":38,"./isArrayLike":85}],52:[function(require,module,exports){
...
},{"../object/keys":114,"../utility/constant":118,"./baseIsMatch":49,"./isStrictComparable":92,"./toObject":101}],53:[function(require,module,exports){
...
},{"../array/last":20,"../lang/isArray":106,"./baseGet":44,"./baseIsEqual":46,"./baseSlice":57,"./isKey":88,"./isStrictComparable":92,"./toObject":101,"./toPath":102}],54:[function(require,module,exports){
...
},{"./toObject":101}],55:[function(require,module,exports){
...
},{"./baseGet":44,"./toPath":102}],56:[function(require,module,exports){
...
},{"../utility/identity":119,"./metaMap":94}],57:[function(require,module,exports){
...
},{"../utility/identity":119,"./binaryIndexBy":60}],60:[function(require,module,exports){
...
},{"../utility/identity":119}],62:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":108,"../utility/constant":118}],63:[function(require,module,exports){
...
},{"./getLength":79,"./isLength":90,"./toObject":101}],66:[function(require,module,exports){
...
},{"./toObject":101}],67:[function(require,module,exports){
(function (global){
...
},{"./createCtorWrapper":68}],68:[function(require,module,exports){
...
},{"../lang/isObject":109,"./baseCreate":37}],69:[function(require,module,exports){
...
},{"../lang/isArray":106,"./baseCallback":34,"./baseFind":39,"./baseFindIndex":40}],70:[function(require,module,exports){
...
},{"../lang/isArray":106,"./bindCallback":61}],71:[function(require,module,exports){
(function (global){
function createHybridWrapper(r,e,a,A,t,o,p,i,l,_){function s(){for(var g=arguments.length,h=g,d=Array(g);h--;)d[h]=arguments[h];if(A&&(d=composeArgs(d,A,t)),o&&(d=composeArgsRight(d,o,p)),n||u){var C=s.placeholder,y=replaceHolders(d,C);if(g-=y.length,_>g){var v=i?arrayCopy(i):null,D=nativeMax(_-g,0),H=n?y:null,T=n?null:y,Y=n?d:null,m=n?null:d;e|=n?PARTIAL_FLAG:PARTIAL_RIGHT_FLAG,e&=~(n?PARTIAL_RIGHT_FLAG:PARTIAL_FLAG),c||(e&=~(BIND_FLAG|BIND_KEY_FLAG));var q=[r,e,a,Y,H,m,T,v,l,D],B=createHybridWrapper.apply(void 0,q);return isLaziable(r)&&setData(B,q),B.placeholder=C,B}}var N=R?a:this;G&&(r=N[I]),i&&(d=reorder(d,i)),L&&l<d.length&&(d.length=l);var U=this&&this!==global&&this instanceof s?F||createCtorWrapper(r):r;return U.apply(N,d)}var L=e&ARY_FLAG,R=e&BIND_FLAG,G=e&BIND_KEY_FLAG,n=e&CURRY_FLAG,c=e&CURRY_BOUND_FLAG,u=e&CURRY_RIGHT_FLAG,F=!G&&createCtorWrapper(r),I=r;return s}var arrayCopy=require("./arrayCopy"),composeArgs=require("./composeArgs"),composeArgsRight=require("./composeArgsRight"),createCtorWrapper=require("./createCtorWrapper"),isLaziable=require("./isLaziable"),reorder=require("./reorder"),replaceHolders=require("./replaceHolders"),setData=require("./setData"),BIND_FLAG=1,BIND_KEY_FLAG=2,CURRY_BOUND_FLAG=4,CURRY_FLAG=8,CURRY_RIGHT_FLAG=16,PARTIAL_FLAG=32,PARTIAL_RIGHT_FLAG=64,ARY_FLAG=128,nativeMax=Math.max;module.exports=createHybridWrapper;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./arrayCopy":30,"./composeArgs":63,"./composeArgsRight":64,"./createCtorWrapper":68,"./isLaziable":89,"./reorder":96,"./replaceHolders":97,"./setData":98}],72:[function(require,module,exports){
(function (global){
function createPartialWrapper(r,e,a,t){function p(){for(var e=-1,i=arguments.length,c=-1,l=t.length,s=Array(i+l);++c<l;)s[c]=t[c];for(;i--;)s[c++]=arguments[++e];var u=this&&this!==global&&this instanceof p?o:r;return u.apply(n?a:this,s)}var n=e&BIND_FLAG,o=createCtorWrapper(r);return p}var createCtorWrapper=require("./createCtorWrapper"),BIND_FLAG=1;module.exports=createPartialWrapper;


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./createCtorWrapper":68}],73:[function(require,module,exports){
...
},{"./baseSetData":56,"./createBindWrapper":67,"./createHybridWrapper":71,"./createPartialWrapper":72,"./getData":77,"./mergeData":93,"./setData":98}],74:[function(require,module,exports){
...
},{"../object/keys":114}],77:[function(require,module,exports){
...
},{"../utility/noop":120,"./metaMap":94}],78:[function(require,module,exports){
var baseProperty=require("./baseProperty"),constant=require("../utility/constant"),realNames=require("./realNames"),support=require("../support"),getFuncName=function(){return support.funcNames?"constant"==constant.name?baseProperty("name"):function(e){for(var r=e.name,n=realNames[r],t=n?n.length:0;t--;){var a=n[t],u=a.func;if(null==u||u==e)return a.name}return r}:constant("")}();module.exports=getFuncName;


},{"../support":117,"../utility/constant":118,"./baseProperty":54,"./realNames":95}],79:[function(require,module,exports){
var baseProperty=require("./baseProperty"),getLength=baseProperty("length");module.exports=getLength;


},{"./baseProperty":54}],80:[function(require,module,exports){
...
},{"../lang/isNative":108,"../utility/constant":118,"./toObject":101}],81:[function(require,module,exports){
...
},{"./bufferClone":62}],84:[function(require,module,exports){
...
},{"./getLength":79,"./isLength":90}],86:[function(require,module,exports){
...
},{"../lang/isArray":106,"./toObject":101}],89:[function(require,module,exports){
...
},{"../chain/lodash":21,"./LazyWrapper":28,"./getFuncName":78}],90:[function(require,module,exports){
...
},{"../lang/isObject":109}],93:[function(require,module,exports){
...
},{"./arrayCopy":30,"./composeArgs":63,"./composeArgsRight":64,"./replaceHolders":97}],94:[function(require,module,exports){
(function (global){
...
},{"../lang/isNative":108}],95:[function(require,module,exports){
...
},{"./arrayCopy":30,"./isIndex":87}],97:[function(require,module,exports){
...
},{"../date/now":25,"./baseSetData":56}],99:[function(require,module,exports){
...
},{"../lang/isArguments":105,"../support":117,"./baseForIn":42,"./isHostObject":86,"./isObjectLike":91}],100:[function(require,module,exports){
...
},{"../lang/isArguments":105,"../lang/isArray":106,"../lang/isString":111,"../object/keysIn":115,"../support":117,"./isIndex":87,"./isLength":90}],101:[function(require,module,exports){
...
},{"../lang/isObject":109,"../lang/isString":111,"../support":117}],102:[function(require,module,exports){
...
},{"../lang/isArray":106,"./baseToString":58}],103:[function(require,module,exports){
...
},{"./LazyWrapper":28,"./LodashWrapper":29,"./arrayCopy":30}],104:[function(require,module,exports){
...
},{"../internal/baseClone":35,"../internal/bindCallback":61}],105:[function(require,module,exports){
...
},{"../internal/isArrayLike":85,"../internal/isObjectLike":91,"../support":117}],106:[function(require,module,exports){
...
},{"../internal/isLength":90,"../internal/isObjectLike":91,"./isNative":108}],107:[function(require,module,exports){
(function (global){
...
},{"../internal/baseIsFunction":48,"./isNative":108}],108:[function(require,module,exports){
...
},{"../internal/isHostObject":86,"../internal/isObjectLike":91,"../string/escapeRegExp":116}],109:[function(require,module,exports){
...
},{"../internal/shimIsPlainObject":99,"../support":117,"./isArguments":105,"./isNative":108}],111:[function(require,module,exports){
...
},{"../internal/isLength":90,"../internal/isObjectLike":91}],113:[function(require,module,exports){
...
},{"../internal/isArrayLike":85,"../internal/shimKeys":100,"../lang/isNative":108,"../lang/isObject":109,"../support":117}],115:[function(require,module,exports){
...
},{"../internal/arrayEach":31,"../internal/isIndex":87,"../internal/isLength":90,"../lang/isArguments":105,"../lang/isArray":106,"../lang/isFunction":107,"../lang/isObject":109,"../lang/isString":111,"../support":117}],116:[function(require,module,exports){
...
},{"../internal/baseToString":58}],117:[function(require,module,exports){
(function (global){
...
},{"../internal/baseProperty":54,"../internal/basePropertyDeep":55,"../internal/isKey":88}],122:[function(require,module,exports){
...
},{"emitter":123,"reduce":124}],123:[function(require,module,exports){
