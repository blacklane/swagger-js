      ...
      if (param.in === 'path') {
        ...
        if (typeof param.collectionFormat !== 'undefined') {
          ...
          if (Array.isArray(qp)) {
            ...
            querystring += this.encodeQueryParam(param.name) + '=' + this.encodeQueryParam(paramValue);
          }
        } else {
          querystring += param.name + '=' + this.encodeQueryParam(paramValue);
        }
      } else if (param.in === 'formData') {
        formParams[param.name] = paramValue;
      }
    }
  }
  ...
  for (var i = 0; i < this.parameters.length; i++) {
    ...
    if (typeof args[param.name] !== 'undefined' && args[param.name].length) {
      ...
      if (param.in === 'body') {
        ...
        formParams[param.name].push(paramValue);
      }
    }
  }
